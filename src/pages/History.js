...
const History = () => {
    return (
        ...
        <ul>
            ...
            <li style={{color: "silver"}}>
                <strong>1980:</strong> Red makes one of the NBA best moves (a trait he’s renowned for), 1 day before the draft. Red trades the 1st & 13th picks to GSW for Robert "The Chief" Parish & Kevin McHale (3rd pick of draft) forming "The Big 3" with Larry "Legend"
            </li>
            <li style={{color: "silver"}}>
